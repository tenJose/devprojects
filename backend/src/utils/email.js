...
var enviarCodigoVerificacion = function (email, codigo) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, transporter.sendMail({
                        ...
                        html: "\n        <h2>Bienvenido a DevProjects</h2>\n        <p>Tu c\u00F3digo de verificaci\u00F3n es: <strong>".concat(codigo, "</strong></p>\n        <p>Este c\u00F3digo expira en 1 hora.</p>\n      "),
                    })];
            case 1:
                _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Error enviando email:', error_1);
...
var generarCodigoVerificacion = function () {
