...
export const createProject = async (req: Request, res: Response) => {
  try {
    const { titulo, descripcion, tecnologias, tipoProyecto, presupuesto, presupuestoTipo, duracionEstimada, ubicacion, usuarioCreadorId } = req.body;
    ...
    const nuevoProyecto = await prisma.proyecto.create({
      data: {
        ...
        estado: 'activo',
        usuarioCreadorId: parseInt(usuarioCreadorId)
      }
    });
...
export const updateProject = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { titulo, descripcion, tecnologias, estado, tipoProyecto, presupuesto, presupuestoTipo, duracionEstimada, ubicacion } = req.body;
    ...
    if (presupuesto) updateData.presupuesto = parseFloat(presupuesto);
