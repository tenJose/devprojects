...
INSERT INTO `_prisma_migrations` VALUES ('50e62aaa-e4b3-423f-852f-f53954378823','1c7a8247a59dcdc20214a6e5f67086a1c0457ade487350c87b8c0880c402418d','2025-11-18 06:26:51.002','20251118062650_init',NULL,NULL,'2025-11-18 06:26:50.497',1);
...
CREATE TABLE `mensajes` (
  ...
  KEY `mensajes_destinatario_fkey` (`destinatario`),
...
CREATE TABLE `proyectos` (
  ...
  PRIMARY KEY (`id`),
  KEY `proyectos_usuarioCreadorId_fkey` (`usuarioCreadorId`),
...
CREATE TABLE `usuarios` (
  ...
  `fotoPerfil` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `usuarios` VALUES (3,'mainetflis@gmail.com','Josecarlos','2002-09-11 00:00:00.000','$2a$10$oIM1i26dDZ78ZKeISiegFejjDTShIGrz/D13VtUpgbQCIQTxDXPpu',NULL,'Tengo una gran formacion para realizar diferentes cosas como no hacer nada y extorcionarme con no haber hecho las redes neuronales a tiempo y tener menos costo que un carton','[\"Node.js\",\"Rust\",\"Go\",\"Ruby\",\"PHP\"]','[\"JavaScript\",\"Go\",\"SQL\",\"C++\",\"Java\"]',NULL,'420000',1,'2025-11-18 07:49:42.092','2025-11-18 07:56:06.045');
...
-- Dump completed on 2025-11-18  1:19:59
